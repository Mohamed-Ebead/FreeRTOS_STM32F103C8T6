...
system/src/newlib/%.o: ../system/src/newlib/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Cross ARM GNU C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wall -Wextra  -g3 -DDEBUG -DUSE_FULL_ASSERT -DSTM32F10X_MD -DUSE_STDPERIPH_DRIVER -DHSE_VALUE=8000000 -I"E:\IMT_ARM\Work_Space\freeRTOS_4_Task_Priority\RTOS\Config" -I"E:\IMT_ARM\Work_Space\freeRTOS_4_Task_Priority\include" -I"E:\IMT_ARM\Work_Space\freeRTOS_4_Task_Priority\RTOS\Source\include" -I"E:\IMT_ARM\Work_Space\freeRTOS_4_Task_Priority\RTOS\Source\portable\GCC\ARM_CM3" -I"../include" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f1-stdperiph" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
